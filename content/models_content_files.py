...
class VideoContentModel(MiddleContentPageModel):
    ...
    Video Content Model
    """
    video_url = models.URLField(verbose_name=_("Video URL"), help_text=_("Pathname to the video file"),
                                validators=[
                                    validators.RegexValidator(regex=r"(^[a-z][a-z0-9-\/_]+\/$)",
                                                              message=_("Enter valid URL!"))
                                ])
    subtitles_url = models.URLField(blank=True, null=True, verbose_name=_("Subtitles URL"),
...
class AudioContentModel(MiddleContentPageModel):
    ...
    Audio Content Model
    """
    text = models.TextField(verbose_name=_("Text"), help_text=_("This is the audio content"),)
